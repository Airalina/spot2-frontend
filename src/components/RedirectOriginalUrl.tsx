...
const Redirect = (): JSX.Element => {
    ...
    return (
        <div className="container mx-auto flex justify-center items-center">
            <div>
                <svg aria-hidden="true" className="w-16 h-16 mx-auto text-gray-300 animate-spin fill-indigo-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className='mt-4 text-xl text-center'>Wait a moment...</p>
            </div>
        </div>
    );
};
